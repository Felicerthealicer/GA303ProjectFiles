...
public class lightChangerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Everything's okay :3");
        }

        ChangeLightColor(Color.green);

        // ChangeLightColor(Color.blue);
        // Whatever we pass into this function is what the function is going to change the color to. 

        // this.gameObject.SetActive(isItorIsntIt);

        // lightWeWantToChange.gameObject.SetActive(false);   
        
        // Destroy(lightWeWantToChange.gameObject);
        //This is how you destroy an object.
    }
    ...
    void Update()
    {
        ...
        // The code in is this function will be called at the start of each update before moving on to the rest of the code in Update()
    ...
    {
        //A private function can only be called from within the script.
    ...
    {
        //When this objet is set active agian from inactive, it will call the code in this function. 
    }
