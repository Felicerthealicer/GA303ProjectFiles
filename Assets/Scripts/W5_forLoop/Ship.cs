...
public class Ship : MonoBehaviour
{
    ...
    {
        for (int i = 0; i < cannons.Count; i++) //for(declare int; conditional; increase index)
        {
            //If it's odd, don't fire.
            //If it's even, fire!
            //The mod Operator (%) does division between the two numbers and returns the remainder.
            //If the remainder of something % 2 is 0, it is even!
    ...
    void FireAllPowerfulCannons() //using foreach loop
    {
        foreach(Cannon c in cannons)
        {
    ...
    void FireAllWeakCannons() //using for loop
    {
        for(int i = 0; i < cannons.Count; i++) //most basic form of for loop, often written like this 
        {
